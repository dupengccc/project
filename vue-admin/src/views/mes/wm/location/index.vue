  ...
  <div class="page-wrapper">
    <el-card shadow="never">
      <div class="search-bar">
        <el-form :inline="true" :model="queryForm" class="search-form">
          <el-form-item label="库位编码">
            <el-input v-model="queryForm.code" placeholder="请输入库位编码" clearable style="width: 180px" @keyup.enter="loadData" />
          </el-form-item>
          <el-form-item label="库位名称">
            <el-input v-model="queryForm.name" placeholder="请输入库位名称" clearable style="width: 180px" @keyup.enter="loadData" />
          </el-form-item>
          <el-form-item label="所属库区">
            <el-select v-model="queryForm.area" placeholder="请选择" clearable style="width: 160px">
      ...
      <el-table :data="pageList" border stripe style="width: 100%; margin-top: 12px">
        ...
        <el-table-column label="库位编码" prop="code" width="130" />
        <el-table-column label="库位名称" prop="name" width="160" />
        <el-table-column label="所属仓库" prop="warehouse" width="140" />
        <el-table-column label="所属库区" prop="area" width="140" />
        <el-table-column label="库位类型" prop="type" width="120" />
        <el-table-column label="容量" prop="capacity" width="100" align="center" />
        ...
        <el-table-column label="操作" width="140" fixed="right" align="center">
          <template #default="{ row }">
            ...
            <el-popconfirm title="确认删除该库位？" @confirm="handleDelete(row)">
              <template #reference>
    ...
    <el-dialog
      ...
      :title="dialogMode === 'add' ? '新增库位' : '编辑库位'"
      width="760px"
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="库位类型" prop="type">
              <el-input v-model="form.type" placeholder="如：货架/栈板位" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
const areaOptions = ['原料A区', '原料B区', '成品A区', '半成品区', '辅料区']

const dataList = ref([
  { id: 1, code: 'L01-A01', name: '货架 A-01', warehouse: '一号原料仓', area: '原料A区', type: '货架', capacity: 50, status: true },
  { id: 2, code: 'L01-A02', name: '货架 A-02', warehouse: '一号原料仓', area: '原料A区', type: '货架', capacity: 50, status: true },
  { id: 3, code: 'L02-A01', name: '栈板位 B-01', warehouse: '二号原料仓', area: '原料B区', type: '栈板位', capacity: 30, status: true },
  { id: 4, code: 'L03-A01', name: '成品货架1', warehouse: '成品仓 A', area: '成品A区', type: '货架', capacity: 100, status: true },
  { id: 5, code: 'L04-A01', name: '半成品1', warehouse: '半成品仓', area: '半成品区', type: '栈板位', capacity: 40, status: true },
  { id: 6, code: 'L05-A01', name: '辅料1', warehouse: '辅料仓', area: '辅料区', type: '货架', capacity: 60, status: false }
])
...
const filterList = computed(() => {
  ...
  const areaKw = normalize(queryForm.area)
  const list = dataList.value.filter((r) => {
    ...
    const ok3 = areaKw ? normalize(r.area) === areaKw : true
    return ok1 && ok2 && ok3
  })
...
function resetForm() {
  ...
  Object.assign(form, { id: null, code: '', name: '', warehouse: '', area: '', type: '', capacity: 0, status: true })
}
