<template>
  <div class="page-wrapper">
      ...
      <div class="search-bar">
        <el-form :inline="true" :model="queryForm" class="search-form">
          <el-form-item label="入库单号">
            <el-input v-model="queryForm.code" placeholder="请输入入库单号" clearable style="width: 180px" @keyup.enter="loadData" />
          </el-form-item>
        ...
        <el-button type="success" @click="handleAdd">
          <el-icon><Plus /></el-icon>新增加单
        </el-button>
      </div>

      <el-table :data="pageList" border stripe style="width: 100%; margin-top: 12px">
        <el-table-column type="index" label="序号" width="70" align="center" />
        <el-table-column label="入库单号" prop="code" width="150" />
        <el-table-column label="物料名称" prop="name" width="160" />
        <el-table-column label="入库数量" prop="qty" width="110" align="center" />
        <el-table-column label="入库单位" prop="unit" width="100" align="center" />
        <el-table-column label="供应商" prop="vendor" width="140" />
        <el-table-column label="入库仓库" prop="warehouse" width="140" />
        <el-table-column label="入库日期" prop="date" width="120" align="center" />
        <el-table-column label="入库人" prop="operator" width="100" align="center" />
        ...
        <el-table-column label="操作" width="140" fixed="right" align="center">
          <template #default="{ row }">
            ...
            <el-popconfirm title="确认删除该入库单？" @confirm="handleDelete(row)">
              <template #reference>
    ...
    <el-dialog
      ...
      :title="dialogMode === 'add' ? '新增加库' : '编辑入库'"
      width="760px"
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="入库单号" prop="code">
              <el-input v-model="form.code" placeholder="请输入入库单号" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="供应商" prop="vendor">
              <el-select v-model="form.vendor" placeholder="请选择" style="width: 100%" clearable>
        ...
        <el-row :gutter="16">
          ...
          <el-col :span="12">
            <el-form-item label="入库人" prop="operator">
              <el-input v-model="form.operator" placeholder="请输入入库人" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="16">
...
const vendorOptions = ['华东钢材有限公司', '明达铝业科技', '南方金属制造厂', '标准件供应商']
const warehouseOptions = ['一号原料仓', '二号原料仓', '成品仓 A', '半成品仓', '辅料仓']

const dataList = ref([
  { id: 1, code: 'IN20250001', name: '不锈钢板', qty: 50, unit: '张', vendor: '华东钢材有限公司', warehouse: '一号原料仓', date: '2025-01-10', operator: '张三', status: '已入库' },
  { id: 2, code: 'IN20250002', name: '铝合金型材', qty: 30, unit: '根', vendor: '明达铝业科技', warehouse: '一号原料仓', date: '2025-01-15', operator: '李四', status: '已入库' },
  { id: 3, code: 'IN20250003', name: '铜线圈', qty: 100, unit: 'kg', vendor: '南方金属制造厂', warehouse: '二号原料仓', date: '2025-02-03', operator: '王五', status: '待入库' },
  { id: 4, code: 'IN20250004', name: '内六角螺丝', qty: 200, unit: '包', vendor: '标准件供应商', warehouse: '辅料仓', date: '2025-02-20', operator: '赵六', status: '已入库' },
  { id: 5, code: 'IN20250005', name: 'PLC 控制器', qty: 20, unit: '台', vendor: '华东钢材有限公司', warehouse: '辅料仓', date: '2025-03-05', operator: '孙七', status: '已入库' },
  { id: 6, code: 'IN20250006', name: '电机外壳', qty: 50, unit: '件', vendor: '明达铝业科技', warehouse: '半成品仓', date: '2025-03-15', operator: '周八', status: '待入库' }
])
...
function resetForm() {
  ...
  Object.assign(form, { id: null, code: '', name: '', qty: 0, unit: '', vendor: '', warehouse: '', date: '', operator: '', status: '待入库' })
}
